    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <div style={{ color: '#64748b', fontSize: 13 }}>Panel del dueño</div>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          {error && (
            <div style={{ color: '#ef4444', fontSize: 13, background: '#ef444415',
              border: '1px solid #ef444444', borderRadius: 8, padding: '8px 12px' }}>
              {error}
            </div>
          )}
          ...
          <button
            ...
            style={{
              ...
              background: pin ? '#6366f1' : '#2a2d3a', color: '#fff',
              fontSize: 15, fontWeight: 600,
              cursor: pin ? 'pointer' : 'default', marginTop: 4,
            }}
          >
